...
function (_super) {
  ...
  function NewsFeedView(rootId) {
    ...
    _this = _super.call(this, rootId, template) || this;
    _this.api = new NewsFeedApi(NEWS_URL);
    _this.feeds = feeds;

    if (_this.feeds.length === 0) {
      _this.feeds = feeds = _this.api.getData();
  ...
  NewsFeedView.prototype.render = function () {
    ...
    for (var i = (currentPage - 1) * 10; i < currentPage * 10; i++) {
      ...
      this.addHtml("\n            <div class=\"p-6 ".concat(this.feeds[i].read ? 'bg-green-500' : 'bg-white', " mt-6 rounded-lg shadow-md transition-colors duration-500 hover:bg-green-100\">\n                <div class=\"flex\">\n                    <div class=\"flex-auto\">\n                        <a href=\"#/show/").concat(id, "\">").concat(title, "</a>\n                    </div>\n                    <div class=\"text-center text-sm\">\n                        <div class=\"w-10 text-white ").concat(read ? 'bg-white text-gray-500' : 'bg-green-300', " rounded-lg px-0 py-2\">").concat(comments_count, "</div>\n                    </div>\n                </div>\n                <div class=\"flex mt-3\">\n                    <div class=\"grid grid-cols-3 text-sm text-gray-500\">\n                        <div><i class=\"fas fa-user mr-1\"></i>").concat(user, "</div>\n                        <div><i class=\"fas fa-heart mr-1\"></i>").concat(points, "</div>\n                        <div><i class=\"fas fa-clock mr-1\"></i>").concat(time_ago, "</div>\n                    </div>\n                </div>\n            </div>\n            "));
    }
...
function (_super) {
  ...
  function NewsDetailView(rootId) {
    ...
    return _super.call(this, rootId, template) || this;
  }
